...
Accurate carbon accounting requires emissions data from partners, vendors, and suppliers. The Emissions Impact Dashboard for Azure gives you transparency on the carbon emissions generated by your usage of Azure cloud services. Microsoft’s carbon accounting extends across all three scopes of emissions with a methodology originally validated by Stanford University in 2018. It uses consistent and accurate carbon accounting to quantify the impact of Microsoft cloud services on customers’ environmental footprint. 

> [!IMPORTANT]
> In February 2024, your data underwent recalculation due to an update in the methodology that allowed for a more detailed attribution of carbon emissions. For more information about these changes, go to [Calculations update FAQ](#calculations-update-faq).
...
1. Select the following link to get to the app: [Emissions Impact Dashboard template app](https://appsource.microsoft.com/marketplace/apps?search=emissions%20impact%20dashboard&page=1). 
